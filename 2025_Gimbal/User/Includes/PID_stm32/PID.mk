...
MATLAB_ROOT          = "E:/MATLAB2020b"
ALT_MATLAB_ROOT      = "E:/MATLAB2020b"
MATLAB_BIN           = "E:/MATLAB2020b/bin"
ALT_MATLAB_BIN       = "E:/MATLAB2020b/bin"
S_FUNCTIONS_LIB      = 
NUMST                = 2
NCSTATES             = 0
...
# Additional includes
ADD_INCLUDES = \
 -IG:/mjw_gimbal_2023  -IG:/mjw_gimbal_2023/PID_stm32  -I$(MATLAB_ROOT)/extern/include  -I$(MATLAB_ROOT)/simulink/include  -I$(MATLAB_ROOT)/rtw/c/src  -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common  -I$(MATLAB_ROOT)/rtw/c/ert  -IG:/STM32/addSrc/inc 
...
%.o: $(subst ",,G:/STM32/addSrc/src)/%.cpp
	@echo ### Source $< done
...
%.o: $(subst ",,G:/STM32/addSrc/src)/%$(SRC_FILE_EXT)
	@echo ### Source $< done
